...
# ============================================================
# FIX 1: More robust section header detection for Prioritization.
# The AI may output "3. PRIORITIZATION" or "PRIORITIZATION" with
# varied formatting. Both patterns are now caught.
# ============================================================
def extract_ai_prioritization_lines(board_analysis_text):
    ...
    for line in lines:
        ...
        # FIX: catch both "PRIORITIZATION" standalone and "3. PRIORITIZATION" prefix
...
# ============================================================
# FIX 2: More robust section header detection for Top Action Items.
# The AI may output "4. TOP ACTION ITEMS" or "TOP ACTION ITEMS" with
# varied formatting. Both patterns are now caught.
# ============================================================
def extract_ai_top_action_items_lines(board_analysis_text):
    ...
    for line in lines:
        ...
        # FIX: catch both "TOP ACTION ITEMS" standalone and "4. TOP ACTION ITEMS" prefix
        if "TOP ACTION ITEMS" in upper or re.search(r"\b4\.\s+TOP ACTION", upper, re.IGNORECASE):
            in_actions = True
...
if reco:
    ...
    # ── Generate only when a request is active ───────────────────────────────
